...
public class Video extends AbstractEmbyObject implements IVideo {
  ...
  @Override
  public void setActors(List<IRole> actors) {
    this.actors = actors;
  }
  ...
  @Override
  public void setDirectors(List<IDirector> directors) {
  ...
  @Override
  public void setMedias(List<IMedia> medias) {
    this.medias = medias;
  }
  ...
  @Override
  public void setWriters(List<IWriter> writers) {
