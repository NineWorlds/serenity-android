...
data class AuthenticationResult(@Json(name = "User") val userInfo: PublicUserInfo, @Json(name = "AccessToken") val accesToken: String, @Json(name = "ServerId") val serverId: String)
