...
data class Search(@Json(name = "SearchHints") val searchHints: List<SearchHint>?, @Json(name = "TotalRecordCount") val totalRecordCount: Int?)
...
data class PlaybackStartInfo(@Json(name = "QueueItem") val queueItem: QueueItem?, @Json(name = "PlaySessionId") val playSessionId: String?)

data class QueueItem(@Json(name = "Id") val id: Long?, @Json(name = "PlaylistItemId") val playlistItemId: String?)

data class PlaybackStartRequest(@Json(name = "CanSeek") val canSeek: Boolean = true)
