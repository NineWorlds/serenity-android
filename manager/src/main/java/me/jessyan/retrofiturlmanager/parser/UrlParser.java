 ...
 * ================================================ Url解析器
 *
 * <p>Created by JessYan on 17/07/2017 17:44 <a href="mailto:jess.yan.effort@gmail.com">Contact
...
public interface UrlParser {
  ...
  /**
   * 将 {@link RetrofitUrlManager#mDomainNameHub} 中映射的 URL 解析成完整的{@link HttpUrl} 用来替换 @{@link
   * Request#url} 达到动态切换 URL
   *
