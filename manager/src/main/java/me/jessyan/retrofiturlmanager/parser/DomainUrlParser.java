...
/**
 * ================================================ 域名解析器, 此解析器用来解析域名, 默认将您的域名作为 BaseUrl, 只会将旧 URL
 * 地址中的域名替换成你想要的地址
 *
 * <p>比如: 1. 旧 URL 地址为 https://www.github.com/wiki, 您调用 {@link RetrofitUrlManager#putDomain(String,
 * String)} 方法传入的 URL 地址是 https://www.google.com/api, 经过本解析器解析后生成的新 URL 地址为
 * http://www.google.com/api/wiki
 *
 * <p>2. 旧 URL 地址为 https://www.github.com/wiki, 您调用 {@link RetrofitUrlManager#putDomain(String,
 * String)} 方法传入的 URL 地址是 https://www.google.com, 经过本解析器解析后生成的新 URL 地址为 http://www.google.com/wiki
 *
 * @see UrlParser Created by JessYan on 17/07/2017 18:23 <a
