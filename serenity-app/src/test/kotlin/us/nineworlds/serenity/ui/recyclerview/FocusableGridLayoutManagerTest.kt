...
class FocusableGridLayoutManagerTest {

  private val mockRecyclerView = mock<RecyclerView>()

  private lateinit var layoutManager: FocusableGridLayoutManager

  @Before
  fun setUp() {
    layoutManager = spy(FocusableGridLayoutManager(ApplicationProvider.getApplicationContext(), 1, 0, false))
  }
