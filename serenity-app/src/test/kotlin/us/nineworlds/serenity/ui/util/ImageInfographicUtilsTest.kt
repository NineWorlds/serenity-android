...
class ImageInfographicUtilsTest : InjectingTest() {
  ...
  @Test fun createVideoResolutionImageReturnsSDImage() {
  ...
  @Test fun createVideoResolutionImageReturns480Image() {
    val view = imageInfographicUtils.createVideoResolutionImage("480", context)
    val shadowDrawable = shadowOf(view!!.drawable)
    assertThat(shadowDrawable.createdFromResId).isEqualTo(R.drawable.res480)
  }

  @Test fun createVideoResolutionImageReturns576Image() {
  ...
  @Test fun createVideoResolutionImageReturns720Image() {
  ...
  @Test fun createVideoResolutionImageReturnsHDImage() {
  ...
  @Test fun createVideoResolutionImageReturns1080Image() {
  ...
  @Test fun createVideoResolutionImageForUnknownImageReturnsNull() {
    val view = imageInfographicUtils.createVideoResolutionImage("unknown", context)
    assertThat(view).isNull()
  }

  @Test fun createVideoResolutionImageForNullImageReturnsNull() {
    val view = imageInfographicUtils.createVideoResolutionImage(null, context)
    assertThat(view).isNull()
  }

  @Test fun createAspectRationImageReturns133RatioImage() {
  ...
  @Test fun createAspectRationImageReturns166RatioImage() {
  ...
  @Test fun createAspectRationImageReturns178RatioImage() {
  ...
  @Test fun createAspectRationImageReturns185RatioImage() {
  ...
  @Test fun createAspectRationImageReturns220RatioImage() {
  ...
  @Test fun createAspectRationImageReturns235RatioImage() {
  ...
  @Test fun createAspectRationImageForNullReturnsNullImage() {
    val view = imageInfographicUtils.createAspectRatioImage(null, context)
    assertThat(view).isNull()
  }

  @Test fun createAspectRationImageForUnknownAspectReturnsNullImage() {
    val view = imageInfographicUtils.createAspectRatioImage("unknown", context)
    assertThat(view).isNull()
  }

  @Test fun createContentRatingImageReturnsGImage() {
  ...
  @Test fun createContentRatingImageReturnsPGImage() {
  ...
  @Test fun createContentRatingImageReturnsPG13Image() {
  ...
  @Test fun createContentRatingImageReturnsRImage() {
  ...
  @Test fun createContentRatingImageReturnsNC17Image() {
  ...
  @Test fun createContentRatingImageReturnsNullImage() {
  ...
  @Test fun createVideoCodecReturnsDivxImage() {
  ...
  @Test fun createVideoCodecReturnsDiv3Image() {
  ...
  @Test fun createVideoCodecReturnsVC1Image() {
  ...
  @Test fun createVideoCodecReturnsh264Image() {
  ...
  @Test fun createVideoCodecReturnsMPEG4Image() {
    val view = imageInfographicUtils.createVideoCodec("mpeg4", context)
    val shadowDrawable = shadowOf(view!!.drawable)
    assertThat(shadowDrawable.createdFromResId).isEqualTo(R.drawable.h264)
  }

  @Test fun createVideoCodecReturnsMPEG2Image() {
  ...
  @Test fun createVideoCodecReturnsMPEG1Image() {
  ...
  @Test fun createVideoCodecReturnsXvidImage() {
  ...
  @Test fun createVideoCodecReturnsNullImage() {
    val view = imageInfographicUtils.createVideoCodec(null, context)
    assertThat(view).isNull()
  }

  @Test fun createVideoCodecReturnsNullImageForUnknown() {
    val view = imageInfographicUtils.createVideoCodec("unknown", context)
    assertThat(view).isNull()
  }

  @Test fun createTVContentRatingReturnsTVGImage() {
  ...
  @Test fun createTVContentRatingReturnsTVPGImage() {
  ...
  @Test fun createTVContentRatingReturnsTV14Image() {
  ...
  @Test fun createTVContentRatingReturnsTVMAImage() {
  ...
  @Test fun createTVContentRatingReturnsTVYImage() {
  ...
  @Test fun createTVContentRatingReturnsTVY7Image() {
  ...
  @Test fun createTVContentRatingReturnsTVNRImage() {
  ...
  @Test fun createAudioChannelsImageReturns0Image() {
  ...
  @Test fun createAudioChannelsImageReturns1Image() {
  ...
  @Test fun createAudioChannelsImageReturns2Image() {
  ...
  @Test fun createAudioChannelsImageReturns6Image() {
  ...
  @Test fun createAudioChannelsImageReturns8Image() {
  ...
  @Test fun createAudioChannelsImageForUnknownReturnsNullImage() {
    val view = imageInfographicUtils.createAudioChannlesImage("unknown", context)
    assertThat(view).isNull()
  }

  @Test fun createAudioChannelsImageForNullReturnsNullImage() {
