...
class MovieSecondaryCategoryJobTest : InjectingTest() {
  ...
  lateinit var job: MovieSecondaryCategoryJob
  ...
  override fun setUp() {
    super.setUp()
    job = MovieSecondaryCategoryJob(expectedVideoId, secondaryCategory)
  }
  ...
  @Module(injects = arrayOf(MovieSecondaryCategoryJobTest::class),
