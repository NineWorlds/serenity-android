...
public final class FragmentTestUtil {
  ...
  public static void startFragment(
      Fragment fragment, Class<? extends AppCompatActivity> activityClass) {
  ...
  public static void startVisibleFragment(
      Fragment fragment, Class<? extends AppCompatActivity> activityClass, int containerViewId) {
  ...
  private static FragmentManager buildFragmentManager(
    ...
    AppCompatActivity activity =
        Robolectric.buildActivity(activityClass).create().start().resume().get();
