...
public class TVShowBrowserPresenterTest extends InjectingTest {
    ...
    @Test
    public void fetchTVCategoriesAddsTVCategoryJobWithExpectedKey() {
    ...
    @Test
    public void fetchTVShowsAddsTVShowRetrievalJobWithExpectedKeyAndCategory() {
    ...
    @Test
    public void onTVCategoryResponseCallsUpdateCategories() throws Exception {
    ...
    @Test
    public void onTVShowResponseCallsDisplayShows() throws Exception {
        MediaContainer mediaContainer = new MediaContainer();
        String expectedKey = RandomStringUtils.randomAlphanumeric(10);
        String expectedCategory = RandomStringUtils.randomAlphanumeric(5);
    ...
    @Test
    public void onTVCategorySecondaryResponseCallsPopulateSecondaryCategories() throws Exception {
        MediaContainer mediaContainer = new MediaContainer();
        String expectedKey = RandomStringUtils.randomAlphanumeric(10);
        String expectedCategory = RandomStringUtils.randomAlphanumeric(5);
        TVCategorySecondaryEvent expectedEvent = new TVCategorySecondaryEvent(mediaContainer, expectedKey, expectedCategory);
