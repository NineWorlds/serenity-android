...
public class FullWidthDetailsOverviewRowPresenter extends RowPresenter {
  ...
  protected int getLayoutResourceId() {
    return us.nineworlds.serenity.R.layout.leanback_fullwidth_details_overview;
  }
  ...
  protected void onSelectLevelChanged(RowPresenter.ViewHolder holder) {
    ...
    if (getSelectEffectEnabled()) {
      ...
      //            ((ColorDrawable)
      // vh.mOverviewFrame.getForeground().mutate()).setColor(dimmedColor);
    }
  }
  ...
  protected void onLayoutOverviewFrame(ViewHolder viewHolder, int oldState, boolean logoChanged) {
    ...
    //            lpActions.height =
    //                    isBanner ? 0 :
    // res.getDimensionPixelSize(R.dimen.lb_details_v2_actions_height);
