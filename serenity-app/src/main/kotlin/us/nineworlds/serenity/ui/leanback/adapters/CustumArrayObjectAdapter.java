...
public class CustumArrayObjectAdapter extends ObjectAdapter {
  private ArrayList<Object> mItems = new ArrayList<Object>();

  /** Constructs an adapter with the given {@link PresenterSelector}. */
  public CustumArrayObjectAdapter(PresenterSelector presenterSelector) {
    super(presenterSelector);
  }

  /** Constructs an adapter that uses the given {@link Presenter} for all items. */
  public CustumArrayObjectAdapter(Presenter presenter) {
    super(presenter);
  }

  /** Constructs an adapter. */
  public CustumArrayObjectAdapter() {
    super();
  }
  ...
  /**
   * Replaces the objects in the given collection to the adapter, starting at the index 0.
   *
   * @param items A {@link Collection} of items to insert.
   */
