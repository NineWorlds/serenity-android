...
@OpenForTesting
class VideoKeyCodeHandlerDelegate(val player: ExoPlayer, val activity: Activity, val presenter: ExoplayerContract.ExoplayerPresenter) {
    ...
    internal fun isKeyCodeStop(keyCode: Int): Boolean = keyCode == KeyEvent.KEYCODE_MEDIA_STOP || keyCode == KeyEvent.KEYCODE_S

    internal fun isKeyCodeSkipBack(keyCode: Int): Boolean = keyCode == KeyEvent.KEYCODE_MEDIA_REWIND ||
        keyCode == KeyEvent.KEYCODE_R ||
        keyCode == KeyEvent.KEYCODE_BUTTON_L1 ||
        keyCode == KeyEvent.KEYCODE_BUTTON_L2

    internal fun isKeyCodeSkipForward(keyCode: Int): Boolean = keyCode == KeyEvent.KEYCODE_MEDIA_FAST_FORWARD ||
        keyCode == KeyEvent.KEYCODE_F ||
        keyCode == KeyEvent.KEYCODE_BUTTON_R1 ||
        keyCode == KeyEvent.KEYCODE_BUTTON_R2

    internal fun isKeyCodePauseResume(keyCode: Int): Boolean = keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE ||
    ...
    internal fun isKeyCodeInfo(keyCode: Int): Boolean = keyCode == KeyEvent.KEYCODE_INFO ||
