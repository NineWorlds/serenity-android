...
@InjectViewState public class TVShowSeasonBrowserPresenter
    extends MvpPresenter<TVShowSeasonBrowserView> {
  ...
  public void onSeasonsRetrievalResponse(SeasonsRetrievalEvent event) {
    List<SeriesContentInfo> seasonList =
        new SeasonsMediaContainer(event.getMediaContainer()).createSeries();
