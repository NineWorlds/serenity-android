...
public class TextClock extends TextView {
   ...
   */
  @SuppressWarnings("UnusedDeclaration") public TextClock(Context context) {
    super(context);
    init();
  }
   ...
   */
  @SuppressWarnings("UnusedDeclaration") public TextClock(Context context, AttributeSet attrs) {
   ...
   */
  @ViewDebug.ExportedProperty public CharSequence getFormat12Hour() {
    return mFormat12;
  }
