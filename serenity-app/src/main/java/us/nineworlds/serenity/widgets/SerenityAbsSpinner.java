...
public abstract class SerenityAbsSpinner extends
	...
	public SerenityAbsSpinner(Context context) {
		super(context);
		initAbsSpinner();
	}

	public SerenityAbsSpinner(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SerenityAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
		...
		CharSequence[] entries = a
				.getTextArray(R.styleable.CustomAbsSpinner_entries);
		if (entries != null) {
	...
	void recycleAllViews() {
		...
		final SerenityAbsSpinner.RecycleBin recycleBin = mRecycler;
