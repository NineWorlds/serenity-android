...
public class SerenityMenuGridLayoutManager extends ExtGridLayoutManager {
  ...
  public SerenityMenuGridLayoutManager(Context context, int spanCount, int orientation,
  ...
  public static final class Builder {
    ...
    @Nullable private View mArrowTowardBegin;
    @Nullable private View mArrowTowardEnd;
    ...
    @NonNull public SerenityMenuGridLayoutManager.Builder offsetFraction(
        @FloatRange(from = 0.0D, to = 1.0D) float offsetFraction) {
      this.mOffsetFraction = offsetFraction;
      this.mOffsetEnabled = true;
      return this;
    }

    @NonNull public SerenityMenuGridLayoutManager.Builder circular(boolean circular) {
      this.mCircular = circular;
      return this;
    }

    @NonNull public SerenityMenuGridLayoutManager.Builder spanCount(int spanCount) {
    ...
    @NonNull public SerenityMenuGridLayoutManager.Builder orientation(int orientation) {
      this.mOrientation = orientation;
      return this;
    }

    @NonNull public SerenityMenuGridLayoutManager.Builder reverseOrder(boolean reverseOrder) {
      this.mReverseOrder = reverseOrder;
      return this;
    }

    @NonNull
    public SerenityMenuGridLayoutManager.Builder navigationArrows(@Nullable View arrowTowardBegin,
    ...
    @NonNull public SerenityMenuGridLayoutManager.Builder spanSizePx(int spanSizePx) {
      this.mSpanSize = spanSizePx;
      return this;
    }

    @NonNull public SerenityMenuGridLayoutManager.Builder spanSizeRes(@DimenRes int spanSizeRes) {
      return this.spanSizePx(this.mCtx.getResources().getDimensionPixelSize(spanSizeRes));
    }

    @NonNull public SerenityMenuGridLayoutManager build() {
      SerenityMenuGridLayoutManager lm =
          new SerenityMenuGridLayoutManager(this.mCtx, this.mSpanCount, this.mOrientation,
              this.mReverseOrder);
