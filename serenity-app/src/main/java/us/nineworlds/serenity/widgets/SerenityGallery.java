 ...
 * <p>
 * Views given to the Gallery should use {@link SerenityGallery.LayoutParams} as their
 ...
 */
public class SerenityGallery extends SerenityAbsSpinner implements GestureDetector.OnGestureListener {
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
         ...
         */
        return new SerenityGallery.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    private void setUpChild(View child, int offset, int x, boolean fromLeft) {
        ...
        // make some up...
        SerenityGallery.LayoutParams lp = (SerenityGallery.LayoutParams) child.getLayoutParams();
        if (lp == null) {
