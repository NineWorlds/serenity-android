...
public class SubtitleResponseListener implements Response.Listener<MediaContainer> {
  ...
  @Override public void onResponse(MediaContainer response) {
    ...
    ArrayAdapter<Subtitle> subtitleAdapter =
        new ArrayAdapter<Subtitle>(context, R.layout.serenity_spinner_textview, spinnerSubtitles);
    subtitleAdapter.setDropDownViewResource(R.layout.serenity_spinner_textview_dropdown);
